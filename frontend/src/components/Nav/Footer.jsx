            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div className="space-y-3">
                        <Link to="/" className="flex items-center gap-2 group">
                            <div className="w-6 h-6 rounded-lg bg-gradient-to-br from-saffron to-indiaGreen flex items-center justify-center text-white font-bold text-sm shadow-lg group-hover:shadow-saffron/30 transition-shadow">
                                G
                            </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li className="flex items-start gap-2 text-xs text-gray-400">
                                ...
                                <span>Ajeenkya DY Patil University,<br />Pune, MH 412105</span>
                            </li>
                            <li className="flex items-center gap-2 text-xs text-gray-400">
                                <Mail size={14} className="flex-shrink-0 text-saffron" />
                                <span>support@govassist.ai</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="border-t border-white/10 mt-6 pt-4 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex gap-4">
                        <Link to="#" className="text-xs text-gray-500 hover:text-white transition-colors">Privacy</Link>
                        <Link to="#" className="text-xs text-gray-500 hover:text-white transition-colors">Terms</Link>
                        <Link to="#" className="text-xs text-gray-500 hover:text-white transition-colors">Cookies</Link>
                    </div>
                </div>
            </div>
        </footer>
